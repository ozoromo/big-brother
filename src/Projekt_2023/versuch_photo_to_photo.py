...
def photo_to_photo(img1, img2):
    ...
    #encodeimg1 = face_recognition.face_encodings(face_Loc_img1)[0]
    encodeimg1 = face_recognition.face_encodings(img1)[0]          #tak bylo
    ...
    #encodeimg2 = face_recognition.face_encodings(face_Loc_img2)[0]
    encodeimg2 = face_recognition.face_encodings(img2)[0]          #tak bylo
    ...
    faceDis = face_recognition.face_distance([encodeimg1],
                                             encodeimg2)  # distance between two photos, measure of comparsion in range [0,1]
...
img2 = face_recognition.load_image_file('ImagesAttendance/Elon Musk.jpg')
img1 = face_recognition.load_image_file('ImagesAttendance/Elon Musk.jpg')
photo_to_photo(img1,img2)
