...
def annotate_image_with_gesture_and_landmarks(image, result):
    ...
    text_y = (annotated_image.shape[0] + text_size[1]) // 2 - 125  # Slightly above the center

    cv2.putText(annotated_image, title, (text_x, text_y), cv2.FONT_HERSHEY_SIMPLEX, 1, (0, 0, 255), 2, cv2.LINE_AA)
