...
testing_image = face_recognition.load_image_file("../../../../res/test_images/merkel.jpg")
training_image = face_recognition.load_image_file("../../../../res/test_images/merkel2.jpg") # image from DB
